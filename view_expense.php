...
<div class="container mt-5">
  ...
  <div class="text-end mb-3">
    <a href="expense.php" class="btn btn-success">
...
if(mysqli_num_rows($result) > 0)
{
    ...
    while($rows = mysqli_fetch_assoc($result))
    {
        echo "<tr>
                ...
                <td>".$rows['year']."</td>
                <td>
                    <a href='edit_expense.php?edit_expenseid=".$rows['id']."' class='btn btn-sm btn-primary' title='Edit'>&#9998;</a>
                    <a href='delete_expense.php?delete_expenseid=".$rows['id']."' class='btn btn-sm btn-danger' title='Delete'>&#128465;</a>
                </td>
              </tr>";
    }
    echo "</tbody></table>";
    ...
    echo "<p class='text-center'>No Expense found</p>";
}
?>
</div>
</body>
